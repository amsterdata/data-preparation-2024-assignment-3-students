...
def execute_pipeline(seed):
    ...
    ratings_usage = np.zeros(len(ratings))
    products_usage = np.zeros(len(products))
    ...
    print(f'Predictive parity w.r.t. third party reviews {predictive_parity}')
    print(f'# Number of ratings used {np.sum(ratings_usage)}')
    print(f'# Number of products used {np.sum(products_usage)}')
    print('---------------------------------------------------------------------\n\n')

    return predictive_parity, ratings_usage, products_usage
